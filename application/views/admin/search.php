					...
					<div class="col-xs-12">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title" id="basic-layout-form">Search Students</h4>
											...
											<div class="row">
												...
												<div class="col-md-12">
													<div class="form-group">
														<label for="projectinput6">Search</label>
...
<script type="text/javascript" src="<?=base_url('jquery-3.4.1.min.js')?>"></script>
<script type="text/javascript">
...
$(document).ready(function(){
 ...
 {
  $.ajax({
   url:"<?php echo base_url(); ?>Searchcntrl/fetch",
   method:"POST",
   data:{query:query},
