					...
					<div class="col-xs-12">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title" id="basic-layout-form">Reply To Complaint</h4>
							...
							<div class="card-body collapse in">
								<div class="card-block">
									<form class="form" action="<?=base_url('Viewstudentcomplaints/update/'.$editdetails->id)?>" method="post">
										<div class="form-body">
											<div class="row">
												...
												<div class="col-md-12">
													...
													<textarea id="" rows="5" class="form-control summernote hidden" value="<?=$editdetails->status?>" name="status" placeholder="About Project"></textarea><?=form_error('status')?>
													</div>
												</div>
