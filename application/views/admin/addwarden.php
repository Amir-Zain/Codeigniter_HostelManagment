			...
			<div class="navbar-container content container-fluid">
				<div id="navbar-mobile" class="collapse navbar-toggleable-sm">
					...
					<ul class="nav navbar-nav float-xs-right">
						...
						<a href="<?=base_url('Alogincontrol/logout')?>" class="dropdown-item"><i class="icon-power3"></i> Logout</a>
						</div>
						</li>
					</ul>
				</div>
	...
	<div data-scroll-to-active="true" class="main-menu menu-fixed menu-light menu-accordion menu-shadow">
		...
		<div class="main-menu-content">
			<ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
				...
				<li class=" nav-item"><a href="<?=base_url('Ahomecontrol')?>"><i class="icon-home3"></i><span data-i18n="nav.dash.main" class="menu-title">Home</span></a>
				</li>


				<li class=" nav-item"><a href="<?=base_url('Addwarden')?>"><i class="icon-equalizer"></i><span data-i18n="nav.components.main" class="menu-title">Add Warden</span></a></li>

				<li class=" nav-item"><a href="<?=base_url('Viewwardencomplaints')?>"><i class="icon-sphere"></i><span data-i18n="nav.icons.main" class="menu-title">View Warden Complaints</span></a>
				</li>

				<li class=" nav-item"><a href="<?=base_url('Viewstudentcomplaints')?>"><i class="icon-bullhorn2"></i><span data-i18n="nav.form_layouts.form_layout_basic" class="menu-title">View Student Complaints</span></a>
				</li>

				

				<li class=" nav-item"><a href="<?=base_url('Searchcntrl')?>"><i class="icon-pen2"></i><span data-i18n="nav.google_charts.main" class="menu-title">Search Student</span></a></li>

				<li class=" nav-item"><a href="business-listing.html"><i class="icon-file-text"></i><span data-i18n="nav.bootstrap_tables.table_basic" class="menu-title">Student Details</span></a>
				</li>
						...
						<div class="card">
							...
							<div class="card-body collapse in">
								<div class="card-block">
									<form class="form" action="<?=base_url('Addwarden/insert')?>" method="post" enctype="multipart/form-data">
										<div class="form-body">
											<div class="row">
												<div class="col-md-6">
												...
												<div class="col-md-6">
													...
													<input type="mail" id="" class="form-control" placeholder="Username" name="username" autocomplete="off" value="<?=set_value('username')?>"><?=form_error('username')?>
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
													<label for="">Photo</label>
													<input type="file" id="" class="form-control" placeholder="Last Name" name="image"><?=isset($error)?$error:''?>
													</div>
												</div>
												...
												<div class="col-md-6">
													...
													<input type="text" id="timepicker" class="form-control" placeholder="Password" name="password" autocomplete="off" value="<?=set_value('password')?>"><?=form_error('password')?>
													</div>
												</div>
												<div class="col-md-6">
													...
													<table id="datatables-example" class="table table-striped table-bordered dataTable no-footer" width="100%" cellspacing="0" role="grid" aria-describedby="datatables-example_info" style="width: 100%;">
														<thead>
															<tr role="row">
																...
																<th class="sorting" tabindex="0" aria-controls="datatables-example" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 130px;">Username</th>
																<th class="sorting" tabindex="0" aria-controls="datatables-example" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 130px;">Password</th>
														...
														<tbody>
															...
															<tr role="row" class="odd">
																...
																<a href="<?=base_url('Addwarden/delete/'.$value->id)?>" onclick="return confirm('Are you sure want to delete this post?')"><span style="color:#fff;" class="btn btn-danger glyphicon glyphicon-trash" title="Delete post"></span></a> 
																</td>
															</tr>
															<?php
																}
