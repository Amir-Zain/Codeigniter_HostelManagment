...
<form action="<?=base_url('Alogincontrol/login')?>" method="post">
<fieldset class="form-group position-relative has-icon-left mb-1">
<input type="text" class="form-control form-control-lg input-lg" id="user-name" placeholder="Your Username" name="username" required><?=form_error('username')?>
<div class="form-control-position">
<i class="icon-head"></i>
</div>
</fieldset>
<fieldset class="form-group position-relative has-icon-left">
<input type="password" class="form-control form-control-lg input-lg" id="user-password" placeholder="Enter Password" name="password" required><?=form_error('password')?>
<div class="form-control-position">
<i class="icon-key3"></i>
</div>
</fieldset>
...
<br>
<a href="<?=('Viewindex')?>"><p align="center">Home</p></a>
</div>
</div>
</div>
</div>
