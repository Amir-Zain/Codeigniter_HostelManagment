...
<form action="<?=base_url('Slogincontrol/login')?>" method="post">
<fieldset class="form-group position-relative has-icon-left mb-1">
<input type="text" class="form-control form-control-lg input-lg" id="user-name" placeholder="Addmission Number" name="addmission" required><?=form_error('addmission')?>
