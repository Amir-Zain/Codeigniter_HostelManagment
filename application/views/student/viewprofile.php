									...
									<form class="form">
										<div class="form-body">
											<div class="row">
												<?php foreach ($details as $value)
		{
			?>                                  <img src="<?=base_url('upload/'.$value->image)?>" width="150" height="150">
												<div class="col-md-12">
												<div class="form-group">
													<label for="">Name</label>
													<input type="text" id="" class="form-control" placeholder="First Name" name="name" autocomplete="off"  readonly="yes" value="<?=$value->name?>">
													</div>
												</div>
													<div class="col-md-12">
													<div class="form-group">
													<label for="">Name of the Guardian</label>
													<input type="text" id="" class="form-control" placeholder="Enter Name" name="fname" autocomplete="off"  readonly="yes" value="<?=$value->fname?>">
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group">
													<label for="">Addmission Number</label>
													<input type="text" id="" class="form-control" placeholder="Enter Phone Number" name="addmission" autocomplete="off"  readonly="yes" value="<?=$value->addmission?>">
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group">
													<label for="">Date Of Birth</label>
													<input type="text" id="" class="form-control" placeholder="Enter Name of the Department" name="birth" autocomplete="off" readonly="yes" value="<?=$value->birth?>">
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group">
													<label for="">Place</label>
													<input type="text" id="" class="form-control" placeholder="Enter Course Name" name="place" autocomplete="off"  readonly="yes" value="<?=$value->place?>">
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group">
													<label for="">Sex</label>
													<input type="text" id="" class="form-control" placeholder=" Enter Batch Year" name="sex" autocomplete="off"  readonly="yes" value="<?=$value->sex?>">
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group">
													<label for="">Address</label>
													<input type="text" id="" class="form-control" placeholder=" Enter Batch Year" name="address" autocomplete="off"  readonly="yes" value="<?=$value->address?>">
													</div>
												</div>
												<?php 
									}
