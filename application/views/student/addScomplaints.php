			...
			<div class="navbar-container content container-fluid">
				<div id="navbar-mobile" class="collapse navbar-toggleable-sm">
					...
					<ul class="nav navbar-nav float-xs-right">
						...
						{
							?>
						<li class="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link"><span class="avatar avatar-online"> <img src="<?=base_url('upload/'.$value->image)?>" width="150" height="150" alt="avatar"><i></i></span><span class="user-name"><?= $value->name?></span></a>
							<?php
						}
						?>
	...
	<div data-scroll-to-active="true" class="main-menu menu-fixed menu-light menu-accordion menu-shadow">
		...
		<div class="main-menu-content">
			<ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
				...
				<li class=" nav-item"><a href="<?=base_url('Shomecontrol')?>"><i class="icon-home3"></i><span data-i18n="nav.dash.main" class="menu-title">Home</span></a>
				</li>


				<li class=" nav-item"><a href="<?=base_url('Viewprofile')?>"><i class="icon-equalizer"></i><span data-i18n="nav.components.main" class="menu-title">View Profile</span></a></li>

				<li class=" nav-item"><a href="<?=base_url('AddScomplaints')?>"><i class="icon-pen2"></i><span data-i18n="nav.icons.main" class="menu-title">Add Complaints</span></a>
				</li>

				<li class=" nav-item"><a href="<?=base_url('Viewfood')?>"><i class="icon-bullhorn2"></i><span data-i18n="nav.form_layouts.form_layout_basic" class="menu-title">View Food</span></a>
				</li>
						...
						<div class="card">
							...
							<div class="card-body collapse in">
								<div class="card-block">
									<form class="form" action="<?=base_url('AddScomplaints/insert')?>" method="post">
										<div class="form-body">
											<div class="row">
												<div class="col-md-6">
													...
													<input type="text" id="" class="form-control" placeholder="Name" value="<?= $value->name?>" name="name" autocomplete="off" value="<?=set_value('name')?>"><?=form_error('name')?>
												...
												<div class="col-md-6">
													...
													<input type="mail" id="" class="form-control" placeholder="Addmission Number" value="<?= $value->addmission?>" name="addmission" autocomplete="off" value="<?=set_value('addmission')?>"><?=form_error('addmission')?>
													</div>
												</div>
													...
													<table id="datatables-example" class="table table-striped table-bordered dataTable no-footer" width="100%" cellspacing="0" role="grid" aria-describedby="datatables-example_info" style="width: 100%;">
														<thead>
															<tr role="row">
																...
																<th class="sorting" tabindex="0" aria-controls="datatables-example" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 130px;">Addmission Number</th>
																...
																<th class="sorting" tabindex="0" aria-controls="datatables-example" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 100px;">Status</th>
																
															</tr>
														</thead>
														<tbody>
															<?php foreach ($details1 as $key =>$value)
																{
															?>	
