			...
			<div class="navbar-container content container-fluid">
				<div id="navbar-mobile" class="collapse navbar-toggleable-sm">
					...
					<ul class="nav navbar-nav float-xs-right">
						<li class="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link"><span class="avatar avatar-online"><img src="<?=base_url('assets/images/avatar-s-1.png')?>" alt="avatar"><i></i></span><span class="user-name">Warden</span></a>
						<div class="dropdown-menu dropdown-menu-right">
						<a href="<?=base_url('Wlogincontrol/logout')?>" class="dropdown-item"><i class="icon-power3"></i> Logout</a>
						</div>
						</li>
					</ul>
				</div>
	...
	<div data-scroll-to-active="true" class="main-menu menu-fixed menu-light menu-accordion menu-shadow">
		...
		<div class="main-menu-content">
			<ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
				...
				<li class=" nav-item"><a href="<?=base_url('Whomecontrol')?>"><i class="icon-home3"></i><span data-i18n="nav.dash.main" class="menu-title">Home</span></a>
				</li>


				<li class=" nav-item"><a href="<?=base_url('Addstudent')?>"><i class="icon-equalizer"></i><span data-i18n="nav.components.main" class="menu-title">Add Student</span></a></li>

				<li class=" nav-item"><a href="<?=base_url('AddWcomplaints')?>"><i class="icon-pen2"></i><span data-i18n="nav.icons.main" class="menu-title">Add Complaints</span></a>
				</li>

				<li class=" nav-item"><a href="<?=base_url('Addfood')?>"><i class="icon-bullhorn2"></i><span data-i18n="nav.form_layouts.form_layout_basic" class="menu-title">Add Food</span></a>
				</li>

				<li class=" nav-item"><a href="<?=base_url('ViewScomplaints')?>"><i class="icon-file-text"></i><span data-i18n="nav.bootstrap_tables.table_basic" class="menu-title">View Student Complaints</span></a>
				</li>
						...
						<div class="card">
							...
							<div class="card-body collapse in">
								<div class="card-block">
									<form class="form" method="post" action="<?=base_url('Addstudent/insert')?>" enctype="multipart/form-data">
										<div class="form-body">
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
													<label for="">Name</label>
													<input type="text" id="" class="form-control" placeholder="Name" name="name" autocomplete="off" value="<?=set_value('name')?>"><?=form_error('name')?>
													</div>
												</div>
												...
												<div class="col-md-6">
													...
													<input type="mail" id="" class="form-control" placeholder="Father Name" name="fname" autocomplete="off" value="<?=set_value('fname')?>"><?=form_error('fname')?>
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
													<label for="">Addmission Number</label>
													<input type="mail" id="" class="form-control" placeholder="Addmission Number" name="addmission" autocomplete="off" value="<?=set_value('addmission')?>"><?=form_error('addmission')?>
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
												...
												<div class="col-md-6">
													...
													<input type="text" id="" class="form-control" placeholder="D O B" name="birth" autocomplete="off" value="<?=set_value('birth')?>"><?=form_error('birth')?>
													</div>
												</div>
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<select name="place" class="select2-B form-control" multiple="multiple">
												...
												<div class="col-md-6">
													...
													<input type="radio" value="male" name="sex" class="custom-control-input" value="<?=set_value('sex')?>"><?=form_error('sex')?>
													<span class="custom-control-indicator"></span>
													<span class="custom-control-description">Male</span>
													</label>
													<label class="display-inline-block custom-control custom-radio">
													<input type="radio" value="female" name="sex" class="custom-control-input" value="<?=set_value('sex')?>"><?=form_error('sex')?>
													<span class="custom-control-indicator"></span>
												...
												<div class="col-md-12">
													...
													<textarea id="" rows="5" class="form-control summernote hidden" name="address" placeholder="About Project" value="<?=set_value('address')?>"></textarea><?=form_error('address')?>
													</div>
												</div>
												<div class="col-md-12">
												<div class="form-group">
											...
											<div class="row">
												<div class="col-sm-12" style="overflow-x: auto;">
													<table id="datatables-example" class="table table-striped table-bordered dataTable no-footer" width="100%" cellspacing="0" role="grid" aria-describedby="datatables-example_info" style="width: 100%;">
														<thead>
															<tr role="row">
																<th class="sorting_asc" tabindex="0" aria-controls="datatables-example" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 130px;">Name</th>
																<th class="sorting" tabindex="0" aria-controls="datatables-example" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 130px;">Father Name</th>
																<th class="sorting" tabindex="0" aria-controls="datatables-example" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 130px;">Addmission Number</th>
																<th class="sorting" tabindex="0" aria-controls="datatables-example" rowspan="1" colspan="1" aria-label="Age: activate to sort column ascending" style="width: 142px;">Date Of Birth</th>
																...
																<th class="sorting" tabindex="0" aria-controls="datatables-example" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending" style="width: 159px;">Photo</th>
															</tr>
														</thead>
														<tbody>
															...
															<tr role="row" class="odd">
																...
																<td><?= $value->fname?></td>
																<td><?= $value->addmission?></td>
																<td><?= $value->birth?></td>
																<td><?= $value->place?></td>
																<td><?= $value->sex?></td>
																<td><img src="<?=base_url('upload/'.$value->image)?>" width="50" height="50"></td>
																<td>
																
																<a href="<?=base_url('Addstudent/delete/'.$value->id)?>" onclick="return confirm('Are you sure want to delete this post?')"><span style="color:#fff;" class="btn btn-danger glyphicon glyphicon-trash" title="Delete post"></span></a> 
																</td>
															</tr>
															<?php
																}
