					...
					<div class="col-xs-12">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title" id="basic-layout-form">Add Food</h4>
							...
							<div class="card-body collapse in">
								<div class="card-block">
									<form class="form" method="post" action="<?=base_url('Addfood/insert')?>">
										<div class="form-body">
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
													<label for="">Day</label>
													<input type="text" id="" class="form-control" placeholder="Day" name="day" autocomplete="off" value="<?=set_value('day')?>"><?=form_error('day');?>
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
													<label for="">Breakfast</label>
													<input type="text" id="" class="form-control" placeholder="Breakfast" name="breakfast" autocomplete="off" value="<?=set_value('breakfast')?>"><?=form_error('breakfast');?>
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
													<label for="">Breakfast Time</label>
													<input type="text" id="" id="timepicker" class="form-control timepicker" placeholder="Breakfast time" name="btime" autocomplete="off" value="<?=set_value('btime')?>"><?=form_error('btime');?>
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
													<label for="">Lunch</label>
													<input type="text" id="" class="form-control" placeholder="Lunch" name="lunch" autocomplete="off" value="<?=set_value('lunch')?>"><?=form_error('lunch');?>
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
													<label for="">Lunch Time</label>
													<input type="text" id="timepicker" class="form-control timepicker" placeholder="Lunch time" name="ltime" autocomplete="off" value="<?=set_value('ltime')?>"><?=form_error('ltime');?>
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
													<label for="">Dinner</label>
													<input type="text" id="timepicker" class="form-control" placeholder="Dinner" name="dinner" autocomplete="off" value="<?=set_value('dinner')?>"><?=form_error('dinner');?>
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
													<label for="">Dinner Time</label>
													<input type="text" id="timepicker" class="form-control timepicker" placeholder="Dinner time" name="dtime" autocomplete="off" value="<?=set_value('dtime')?>"><?=form_error('dtime');?>
													</div>
												</div>
