 value="<?=set_value('dtime')?>"<!DOCTYPE html>
			...
			<div class="navbar-container content container-fluid">
				<div id="navbar-mobile" class="collapse navbar-toggleable-sm">
					...
					<ul class="nav navbar-nav float-xs-right">
						...
						<a href="<?=base_url('Slogincontrol/logout')?>" class="dropdown-item"><i class="icon-power3"></i> Logout</a>
						</div>
						</li>
					</ul>
				</div>
					...
					<div class="col-xs-12">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title" id="basic-layout-form">Add Complaint</h4>
							...
							<div class="card-body collapse in">
								<div class="card-block">
									<form class="form" action="<?=base_url('AddWcomplaints/insert')?>" method="post">
										<div class="form-body">
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
													<label for=""> Warden Name</label>
													<input type="text" id="" class="form-control" placeholder=" Warden Name" name="name" autocomplete="off" value="<?=set_value('name')?>"><?=form_error('name')?>
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
													<label for=""> Student Addmission Number</label>
													<input type="mail" id="" class="form-control" placeholder="Student Addmission Number" name="addmission" autocomplete="off" value="<?=set_value('addmission')?>"><?=form_error('addmission')?>
													</div>
												</div>
												...
												<div class="col-md-6">
													...
													<input type="text" id="" class="form-control" placeholder="Date" name="datex" autocomplete="off" value="<?=set_value('datex')?>"><?=form_error('datex')?>
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group">
													<label for="">Complaint</label>
													<textarea id="" rows="5" class="form-control summernote hidden" name="complaint" placeholder="About Project" value="<?=set_value('complaint')?>"></textarea><?=form_error('complaint')?>
													</div>
												</div>
											...
											<div class="row">
												<div class="col-sm-12" style="overflow-x: auto;">
													<table id="datatables-example" class="table table-striped table-bordered dataTable no-footer" width="100%" cellspacing="0" role="grid" aria-describedby="datatables-example_info" style="width: 100%;">
														<thead>
															<tr role="row">
																<th class="sorting_asc" tabindex="0" aria-controls="datatables-example" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 130px;"> Warden Name</th>
																<th class="sorting" tabindex="0" aria-controls="datatables-example" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 130px;"> Student Addmission Number</th>
																<th class="sorting" tabindex="0" aria-controls="datatables-example" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 100px;">Date</th>
																<th class="sorting" tabindex="0" aria-controls="datatables-example" rowspan="1" colspan="1" aria-label="Age: activate to sort column ascending" style="width: 142px;">Complaint</th>
